...
alias nec='emacsclient -n -c'

alias repl11='cd /tmp && sbt-extras -211 -Dscala.color -sbt-create console && echo "sbt $PWD/target directory..." && rm -rf ./target && echo "removed" && cd -'
alias repl12='cd /tmp && sbt-extras -212 -Dscala.color -sbt-create console && echo "sbt $PWD/target directory..." && rm -rf ./target && echo "removed" && cd -'
